...
import { IotDeviceResponseInterface, JwtPyloadInterface } from '@domotica/shared/interfaces';
...
export class IotDeviceController {
  ...
  @Get('favorites')
  async getFavorites(@AuthUser() auth: JwtPyloadInterface): Promise<IotDeviceResponseInterface[]> {
